      ...
      <div class="content-area">
        <div id="_grid" class="app-grid">
          ...
          <!--widget-layout key="__bmp280">
            ...
            <bmp280-widget ticks="8" last-temperature="{{__bmp280_temperature}}" last-pressure="{{__bmp280_pressure}}" last-altitude="{{__bmp280_altitude}}"></bmp280-widget>
          </widget-layout-->
          ...
          <!--widget-layout key="__bme280">
            ...
            <bme280-widget ticks="8" last-temperature="{{__bme280_temperature}}" last-humidity="{{__bme280_humidity}}" last-pressure="{{__bme280_pressure}}" last-altitude="{{__bme280_altitude}}"></bme280-widget>
          </widget-layout-->
          ...
          <widget-layout key="__bmp6280">
            ...
            <bme680-widget ticks="8" last-temperature="{{__bme680_temperature}}" last-humidity="{{__bme680_humidity}}" last-pressure="{{__bme680_pressure}}" last-gas="{{__bme680_gas}}" last-altitude="{{__bme680_altitude}}"></bme680-widget>
          </widget-layout>
